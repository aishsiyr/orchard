  ...
  return (
    <div>
      <label className="themeSwitcherThree relative inline-flex cursor-pointer select-none items-center">
        ...
        <div className="shadow-card flex h-[px] w-[84px] items-center justify-center rounded-md">
          <span
            onClick={handleLightMode}
            className={`flex h-9 w-9 items-center justify-center rounded cursor-pointer ${
              !isChecked ? "bg-primary" : "text-body-color"
            }`}
          >
            <svg
              width="24"
